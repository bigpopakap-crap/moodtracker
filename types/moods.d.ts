declare namespace Moods {
  import DateTime = Util.Types.DateTime;
  import IconKey = Util.Types.IconKey;
  import Color = Util.Types.Color;
  import TranslationKey = Translations.TranslationKey;
  import StoredObject = Util.Storage.StoredObject;
